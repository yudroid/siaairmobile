...
//    UIBezierPath * bezier = [UIBezierPath bezierPathWithRect:CGRectMake(0, 0, currentWidth, self.frame.size.height)];
    UIBezierPath * bezier = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 0, currentWidth, viewHeight(self)) byRoundingCorners:UIRectCornerBottomRight|UIRectCornerTopRight cornerRadii:CGSizeMake(10, 10)];
    return bezier;
}
...
- (CAShapeLayer *)shapeLayer{
    ...
    //绘制圆角
    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:layer.frame
                                                   byRoundingCorners:UIRectCornerAllCorners
                                                         cornerRadii:layer.frame.size];
