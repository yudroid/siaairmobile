...
-(void)initTitle
{
    ...
    [self titleViewAddTitleText:@"图片选择"];
...
//    SJPickPhotoCell *cell = (SJPickPhotoCell *)[collectionView cellForItemAtIndexPath:indexPath];
////    [self changeCell:cell WithModel:cell.model];
//    [self pickedArrayChangeWithModel:cell.model];
