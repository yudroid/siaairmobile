...
- (void)setupViews {
    ...
    {
        self.fullButton = [[UIButton alloc]initWithFrame:CGRectMake(0, 0,Image_W, Image_W)];
//        self.fullButton.backgroundColor = [UIColor blackColor];
        [self.fullButton addTarget:self action:@selector(pickBtnAction:) forControlEvents:(UIControlEventTouchUpInside)];
