...
//周字符 英文转中文
-(NSString *)ENWeekShortStringToCN:(NSString *)enString
{

    NSDictionary *weekShortDictionary = @{@"Mon":@"星期一",
                                          @"Tue":@"星期二",
                                          @"Wed":@"星期三",
                                          @"Thu":@"星期四",
                                          @"Fri":@"星期五",
                                          @"Sat":@"星期六",
                                          @"Sun":@"星期日"};
    return [weekShortDictionary objectForKey:enString];
}
@end
