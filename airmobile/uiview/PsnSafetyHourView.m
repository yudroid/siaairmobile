...
-(instancetype) initWithFrame:(CGRect)frame
{
    ...
    if(self){
        ...
        UILabel *planLabel = [CommonFunction addLabelFrame:CGRectMake(20, 5+23 , 100, 15) text:@"旅客人数" font:15 textAlignment:NSTextAlignmentLeft colorFromHex:0xFFFFFFFF];
        ...
        UILabel *maxLabel = [CommonFunction addLabelFrame:CGRectMake(20, 5+23+15+2, topBgView.frame.size.width-40, 12) text:@"4000" font:12 textAlignment:NSTextAlignmentRight colorFromHex:0xFFFFFFFF];
