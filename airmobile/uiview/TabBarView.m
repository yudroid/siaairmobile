...
-(id)initTabBarWithModel:(TabBarBgModel)model selectedType:(TabBarSelectedType)type delegate:(id<TabBarViewDelegate>)delegate
    {
        self = [super initWithFrame:CGRectMake(0, kScreenHeight-49, kScreenWidth, 49)];
        ...
        if (self)
        {
            ...
            homePageBtn.tag = 0;
            [homePageBtn addTarget:self action:@selector(iteamBtnClickedWithSender:) forControlEvents:UIControlEventTouchUpInside];
            ...
            flightPageBtn.tag = 1;
            [flightPageBtn addTarget:self action:@selector(iteamBtnClickedWithSender:) forControlEvents:UIControlEventTouchUpInside];
...
//          BOOL hasNewMessage = [PersistenceUtils unReadCount]>0;
            ...
            messageBtn.tag = 2;
            [messageBtn addTarget:self action:@selector(iteamBtnClickedWithSender:) forControlEvents:UIControlEventTouchUpInside];
            ...
            functionBtn.tag = 3;
            [functionBtn addTarget:self action:@selector(iteamBtnClickedWithSender:) forControlEvents:UIControlEventTouchUpInside];
            ...
            userInfoBtn.tag = 4;
            [userInfoBtn addTarget:self action:@selector(iteamBtnClickedWithSender:) forControlEvents:UIControlEventTouchUpInside];
