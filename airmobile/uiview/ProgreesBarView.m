...
-(void)animationWithStrokeEnd:(CGFloat)strokeEnd
{
    ...
    switch (direction) {
        case 1:
            bAni.fromValue  = [NSValue valueWithCGRect:CGRectMake(0,
                                                                  0,
                                                                  0,
                                                                  self.frame.size.height)];// 从左到右
            bAni.toValue    = [NSValue valueWithCGRect:CGRectMake(0,
                                                                  0,
                                                                  self.frame.size.width*strokeEnd,
        ...
        case 2:
            bAni.fromValue  = [NSValue valueWithCGRect:CGRectMake(0,
                                                                  ...
                                                                  self.frame.size.height)];// 从上到下
            bAni.toValue    = [NSValue valueWithCGRect:CGRectMake(0,
                                                                  0,
                                                                  self.frame.size.width,
                                                                  self.frame.size.height*(1-strokeEnd))];
            break;
        ...
        case 3:
            bAni.fromValue  = [NSValue valueWithCGRect:CGRectMake(0,
                                                                  0,
                                                                  self.frame.size.width,
                                                                  self.frame.size.height)];// 从右到左
            bAni.toValue    = [NSValue valueWithCGRect:CGRectMake(0,
                                                                  0,
                                                                  self.frame.size.width*(1-strokeEnd),
                                                                  self.frame.size.height)];
            break;
        ...
        case 4:
            ...
            bAni.toValue    = [NSValue valueWithCGRect:CGRectMake(0,
                                                                  self.frame.size.height,
                                                                  self.frame.size.width,
                                                                  -self.frame.size.height*strokeEnd)];
