...
-(instancetype) initWithStyle: (UITableViewCellStyle)style reuseIdentifier: (NSString *)identifier flightHour: (FlightHourModel *)flightHour
{
    self = [super init];
    if(self){
        [self.contentView addSubview:[CommonFunction addLabelFrame:CGRectMake(20, 0, kScreenWidth/2-20, viewHeight(self.contentView)) text:flightHour.hour font:18 textAlignment:(NSTextAlignmentLeft) colorFromHex:0xFF000000]];
